...
<nav class="main-header navbar navbar-expand navbar-white navbar-light" style="position: sticky; top: 0px;">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link"><b><?php echo e(auth()->user()->name); ?></b></a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#" style="border-left: 3px solid #0d6efd">
          <i class="fa fa-user"></i> <?php echo e(Str::of(auth()->user()->name)->explode(' ')->map(fn ($name) => $name[0])->join('')); ?>

        </a>
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <span class="dropdown-item dropdown-header">Pengaturan</span>
          <div class="dropdown-divider"></div>
          <a href="/backoffice/user-data/user/<?php echo e(auth()->user()->id); ?>/profile" class="dropdown-item">
  ...
  <!-- /.navbar --><?php /**PATH D:\PROYEK AKHIR\PA-Adigra\resources\views/backoffice/layout/navbar.blade.php ENDPATH**/ ?>