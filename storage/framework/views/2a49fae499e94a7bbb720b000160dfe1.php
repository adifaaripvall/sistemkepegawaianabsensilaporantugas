...
<head>
    ...
    <title>Absensi <?php echo $__env->yieldContent('title'); ?></title>

    
    <link rel="icon" type="image/png" href="<?php echo e(asset('images/mareca.logo.png')); ?>">
    ...
    <link rel="stylesheet"
        href="<?php echo e(asset('assets/adminlte/plugins/datatables-responsive/css/responsive.bootstrap4.min.css')); ?>">
    <!-- Ionicons -->
    ...
    <div class="login-box">
        <div class="card">
            <div class="text-center">
                <img src="<?php echo e(asset('images/tekmt.png')); ?>" class="img-fluid rounded mt-4" alt="" style="height: 160px; width: 180px">
            </div>
            ...
            <div class="card-body login-card-body">
                ...
                <div class="alert alert-success">
                    ...
                    <h4 class="message-head"><?php echo e(session('message')); ?></h4>
                </div>
                <?php endif; ?>
                <form action="<?php echo e(route('login.action')); ?>" method="POST">
                    ...
                    <?php if($errors->has('email')): ?>
                        <span class="help-block text-danger mb-4"><?php echo e($errors->first('email')); ?></span>
                    <?php endif; ?>
                    <div class="input-group mb-3">
                        <input type="text" name="email" class="form-control <?php if($errors->has('email')): ?> is-invalid <?php endif; ?>" 
                    ...
                    <?php if($errors->has('password')): ?>
                        <span class="help-block text-danger mb-4"><?php echo e($errors->first('password')); ?></span>
                    <?php endif; ?>
                    <div class="input-group mb-3">
        ...
        <script src="<?php echo e(asset('assets/adminlte/plugins/datatables-responsive/js/dataTables.responsive.min.js')); ?>">
        </script>
        <script src="<?php echo e(asset('assets/adminlte/plugins/datatables-responsive/js/responsive.bootstrap4.min.js')); ?>">
        </script>

</body>

</html>
<?php /**PATH D:\PROYEK AKHIR\PA-Adigra\resources\views/auth/login.blade.php ENDPATH**/ ?>